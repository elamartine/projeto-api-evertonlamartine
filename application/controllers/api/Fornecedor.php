...
class Fornecedor extends RestController{
    ...
    public function index_get($id=NULL){
        if ($id==NULL){
            $resultado = $this->FornecedoModel->recuperarTodos();
            return $this->response($resultado, RestController::HTTP_OK);
        }else{
            $resultado = $this->FornecedoModel->recuperarPorId($id);
    ...
    public function index_post(){
        ...
        $this->FornecedoModel->inserir($fornecedor);
    ...
    public function index_put($id){
        ...
        $this->FornecedoModel->atualizar($id, $fornecedor);
        $resultado["status"]=true;
    ...
    public function index_delete($id){
        $this->FornecedoModel->excluir($id);
        $resultado["status"]=true;
